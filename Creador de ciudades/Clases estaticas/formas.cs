...
namespace Creador_de_ciudades.Clases_estaticas
{
    ...
    {    
        ...
        {                     
            ...
            Rectangle pared = new Rectangle(informacion.punto_origen,new Size(informacion.nuevo_ancho_forma * 100,informacion.nuevo_alto_forma * 100));
            ...
            int ancho_suelo = informacion.nuevo_ancho_forma * 100 - informacion.grosor_pared * 2;
            int alto_suelo = informacion.nuevo_alto_forma * 100 - informacion.grosor_pared * 2;
